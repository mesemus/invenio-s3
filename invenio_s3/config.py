...
S3_UPLOAD_URL_EXPIRATION = 3600 * 24 * 14
"""Number of seconds the file upload URL will be valid. The default here is 14 days
to allow large file uploads with large number of chunks to be completed.
